 ...
 *
 * **Heads up!**  When using `sass-embedded` npm package, **{@link render} is
 * almost always faster than {@link renderSync}**, due to the overhead of
 ...
 *
 * **Heads up!** When using `sass` npm package, **{@link renderSync} is almost
 * twice as fast as {@link render}** by default, due to the overhead of making
 * the entire evaluation process asynchronous.
 *
 * ```js
 * const sass = require('sass'); // or require('node-sass');
 *
