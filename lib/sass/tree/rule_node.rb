...
module Sass::Tree
  ...
  class RuleNode < Node
    ...
    def self.resolved(selector, selector_source_range, stack_trace = nil)
      rule = new(selector)
      rule.resolved_rules = selector
      rule.selector_source_range = selector_source_range
      rule.line = selector_source_range.start_pos.line
      rule.filename = selector_source_range.file
      rule.stack_trace = stack_trace
      rule
    end
