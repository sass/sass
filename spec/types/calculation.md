...
1: The strings `calc(`, `clamp(`, `min(`, `max(`, and `var(` are matched
case-insensitively.
...
* If `value` is a `CalcArgument`, `MinMaxCalcExpression`, `Number`, or
  `ParenthesizedVar`, return the result of evaluating it.
