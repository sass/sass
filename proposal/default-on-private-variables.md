...
The syntax for variable declaration will remain unchanged. However, the
semantics governing the use of the `!default` flag with private variables will
be modified as described in the [Semantics](#semantics) section.
